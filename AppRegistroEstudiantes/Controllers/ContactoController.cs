...
namespace AppRegistroEstudiantes.Controllers
{
    public class ContactoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,Telefono,Correo,Asunto,Mensaje")] Contacto contacto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,Telefono,Correo,Asunto,Mensaje")] Contacto contacto)
        {
            if (ModelState.IsValid)
            {
